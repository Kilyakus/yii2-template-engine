var UIBlockUI = function() {
    ...
    var handleSample1 = function() {
        ...
        $('#blockui_sample_1_1').click(function() {
            ...
            window.setTimeout(function() {
                Engine.unblockUI('#blockui_sample_1_portlet_body');
            }, 2000);
        });
    ...
    var handleSample2 = function() {
        ...
        $('#blockui_sample_2_3').click(function() {
            Engine.startPageLoading({message: 'Please wait...'});
        ...
        $('#blockui_sample_2_4').click(function() {
            Engine.startPageLoading({animate: true});
    ...
    var handleSample3 = function() {
        ...
        $('#blockui_sample_3_1_1').click(function() {
            Engine.unblockUI('#blockui_sample_3_1_element');
        });
        ...
        $('#blockui_sample_3_2_1').click(function() {
            Engine.unblockUI('#blockui_sample_3_2_element');
        });
    }
    ...
    var handleSample4 = function() {
        ...
        $('#blockui_sample_4_1').click(function() {
            ...
            window.setTimeout(function() {
                Engine.unblockUI('#blockui_sample_4_portlet_body');
            }, 2000);
        });
