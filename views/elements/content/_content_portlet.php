			...
			<div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
				...
				<div class="kt-timeline-v2__item">
					...
					<div class="kt-list-pics kt-list-pics--sm kt-padding-l-20">
						<a href="javascript://"><img src="./test/media/users/100_4.jpg" title=""></a>
						<a href="javascript://"><img src="./test/media/users/100_13.jpg" title=""></a>
						<a href="javascript://"><img src="./test/media/users/100_11.jpg" title=""></a>
						<a href="javascript://"><img src="./test/media/users/100_14.jpg" title=""></a>
					</div>
				</div>
				<div class="kt-timeline-v2__item">
					...
					<div class="kt-timeline-v2__item-text kt-padding-top-5">
						Make Deposit <a href="javascript://" class="kt-link kt-link--brand kt-font-bolder">USD 700</a> To ESL.
					</div>
				</div>
				<div class="kt-timeline-v2__item">
				...
				<div class="kt-timeline-v2__item">
					...
					<div class="kt-timeline-v2__item-text kt-padding-top-5">
						Placed a new order in <a href="javascript://" class="kt-link kt-link--brand kt-font-bolder">SIGNATURE MOBILE</a> marketplace.
					</div>
				</div>
				<div class="kt-timeline-v2__item">
					<span class="kt-timeline-v2__item-time">16:00</span>
				...
				<div class="kt-timeline-v2__item">
					...
					<div class="kt-timeline-v2__item-text kt-padding-top-5">
						Received a new feedback on <a href="javascript://" class="kt-link kt-link--brand kt-font-bolder">FinancePro App</a> product.
					</div>
				</div>
				<div class="kt-timeline-v2__item">
					...
					<div class="kt-timeline-v2__item-text kt-padding-top-5">
						New notification message has been received on <a href="javascript://" class="kt-link kt-link--brand kt-font-bolder">LoopFin Pro</a> product.
					</div>
				</div>
			</div>
		</div>
