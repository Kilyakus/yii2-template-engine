		...
		<div class="tab-content">
				...
				<div class="kt-widget4">
					<div class="kt-widget4__item">
						<div class="kt-widget4__pic kt-widget4__pic--pic">
							<img src="./test/media/users/100_4.jpg" alt="">
						</div>
					...
					<div class="kt-widget4__item">
						<div class="kt-widget4__pic kt-widget4__pic--pic">
							<img src="./test/media/users/100_14.jpg" alt="">
						</div>
						<div class="kt-widget4__info">
							<a href="javascript://" class="kt-widget4__username">
								Milano Esco
					...
					<div class="kt-widget4__item">
						<div class="kt-widget4__pic kt-widget4__pic--pic">
							<img src="./test/media/users/100_11.jpg" alt="">
						</div>
						<div class="kt-widget4__info">
							<a href="javascript://" class="kt-widget4__username">
								Nick Bold
					...
					<div class="kt-widget4__item">
						<div class="kt-widget4__pic kt-widget4__pic--pic">
							<img src="./test/media/users/100_1.jpg" alt="">
						</div>
						<div class="kt-widget4__info">
							<a href="javascript://" class="kt-widget4__username">
								Wiltor Delton
					...
					<div class="kt-widget4__item">
						<div class="kt-widget4__pic kt-widget4__pic--pic">
							<img src="./test/media/users/100_5.jpg" alt="">
						</div>
						<div class="kt-widget4__info">
							<a href="javascript://" class="kt-widget4__username">
								Nick Stone
			...
			<div class="tab-pane" id="kt_widget4_tab2_content">
				<div class="kt-widget4">
					<div class="kt-widget4__item">
						<div class="kt-widget4__pic kt-widget4__pic--pic">
							<img src="./test/media/users/100_2.jpg" alt="">
						</div>
						<div class="kt-widget4__info">
							<a href="javascript://" class="kt-widget4__username">
								Kristika Bold
					...
					<div class="kt-widget4__item">
						<div class="kt-widget4__pic kt-widget4__pic--pic">
							<img src="./test/media/users/100_13.jpg" alt="">
						</div>
						<div class="kt-widget4__info">
							<a href="javascript://" class="kt-widget4__username">
								Ron Silk
					...
					<div class="kt-widget4__item">
						<div class="kt-widget4__pic kt-widget4__pic--pic">
							<img src="./test/media/users/100_9.jpg" alt="">
						</div>
						<div class="kt-widget4__info">
							<a href="javascript://" class="kt-widget4__username">
								Nick Bold
					...
					<div class="kt-widget4__item">
						<div class="kt-widget4__pic kt-widget4__pic--pic">
							<img src="./test/media/users/100_8.jpg" alt="">
						</div>
						<div class="kt-widget4__info">
							<a href="javascript://" class="kt-widget4__username">
								Nick Bold
