	...
	<div class="kt-portlet__body">
		<div class="kt-widget3">
			<div class="kt-widget3__item">
				<div class="kt-widget3__header">
					<div class="kt-widget3__user-img">
						<img class="kt-widget3__img" src="./test/media/users/user1.jpg" alt="">
					</div>
			...
			<div class="kt-widget3__item">
				<div class="kt-widget3__header">
					<div class="kt-widget3__user-img">
						<img class="kt-widget3__img" src="./test/media/users/user4.jpg" alt="">
					</div>
					<div class="kt-widget3__info">
						<a href="javascript://" class="kt-widget3__username">
							Lebron King James
			...
			<div class="kt-widget3__item">
				<div class="kt-widget3__header">
					<div class="kt-widget3__user-img">
						<img class="kt-widget3__img" src="./test/media/users/user5.jpg" alt="">
					</div>
					<div class="kt-widget3__info">
						<a href="javascript://" class="kt-widget3__username">
							Deb Gibson
