...
<html lang="<?= Yii::$app->language ?>">
	...
	<body <?= Layout::getHtmlOptions('body') ?>>
		...
		<?php $this->beginBody() ?>
			...
			<div style="width:100%;height:100%;background-color:#FAFAFA;background-image:url('https://wallpapercave.com/wp/wp3434335.jpg');background-size:cover;position:fixed;"></div>
